...
interface ReviewCardWithActionsProps {
  review: Review;
  showDeleteButton?: boolean;
}

export function ReviewCardWithActions({ review, showDeleteButton = false }: ReviewCardWithActionsProps) {
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent onClick={(e) => e.stopPropagation()}>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this review for {review.game.title}? This action cannot be undone.
